...
class _DayPlanScreenState extends State<DayPlanScreen> with WidgetsBindingObserver {
  ...
  List<Place> _currentList() {
    ...
    if (_selectedTab == "All") {
      ...
      for (final list in _categoryPoolsTop.values) {
        for (final p in list) {
          ...
          Expanded(
            child: InkWell(
              onTap: () {
                ...
                setState(() {
                  _selectedTab = "All"; // vždy návrat na All (Yours)
                  if (wasTop) _popFilter = _PopularityFilter.all; // vypnout Top
                });
            ...
            child: InkWell(
              onTap: () {
                ...
                setState(() {
                  ...
                  // když Top vypínáš → vždy na All (Yours)
                  if (!turnOn) {
                    _selectedTab = "All";
                  }
                });
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: _buildTipsTopToggle(context, tipsAccent, tipsEmoji),
        actions: [
          IconButton(
                ...
                ? ListView.builder(
                  ...
                  itemBuilder: (context, i) {
                    ...
                    return PlaceCard(
                      ...
                      onAddToAll: alreadyInYours ? null : () => _addToAllFromCurrentTab(place),
